...
func (mine *TaskService) AppendAgent(ctx context.Context, in *pb.RequestFlag, out *pb.ReplyList) error {
...
func (mine *TaskService) SubtractAgent(ctx context.Context, in *pb.RequestFlag, out *pb.ReplyList) error {
